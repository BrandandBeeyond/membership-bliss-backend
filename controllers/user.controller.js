...
const sendOTP = async (req, res) => {
  try {
    ...
    const msg = `Your Touchwood Bliss Membership login OTP is ${otp}. Do not share this code with anyone. Visit touchwoodbliss.com for more information.${ANDROID_APP_SIGNATURE}`;
