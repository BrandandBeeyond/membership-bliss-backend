...
const { generateClaimCode, hashCode, encryptCode, makeClaimMembership, makeGenerateOfflineClaimCode, makeRevealOfflineClaimCode } = require("../services/offline-claim");
...
const createOfflineBookingByAdmin = async (req, res) => {
  try {
    ...
    const bookingPayload = {
      ...
      claimCodeCiphertext: encryptCode(claimCode),
...
const revealOfflineClaimCode = makeRevealOfflineClaimCode({ MembershipBooking });
